...
import 'package:flutter_airbnb/components/common/common_form_filed.dart';
...
class HomeHeaderForm extends StatelessWidget {
  ...
  Widget _buildFormTitle() {
    return Column(
      children: [
        ...
        Text(
          "혼자하는 여행에 적합한 개인실부터 여럿이 함게하는 여행에 좋은 '공간전체' 숙소까지, 모두의 숙소에 다 있습니다.",
          style: body1(),
        ),
        SizedBox(
          height: gap_m,
  ...
  // TxtButton, OutlinedButton, OverflowButton, InkWell+Container
